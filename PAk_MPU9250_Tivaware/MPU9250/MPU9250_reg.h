...
// MPU9250 address
#define MPU9250_ADDR 				0x68//AD0=0
...
#define MPUREG_DMP_INT_STATUS	    0x39  // Check DMP interrupt
...
#define BITS_CLKSEL_STOP			0x07
#define BITS_CLKSEL_INTERNAL		0x01
#define BITS_CLKSEL_AUTO			0x02
...
#define     MagnetSensitivityScaleFactor ((float)0.15f)
